...
/**
 * The factory service for {@link PoolAccess}s.
 */
public class PoolAccessFactory implements ConletComponentFactory {
    ...
    public Optional<ComponentType> create(Channel componentChannel,
            Map<?, ?> properties) {
        return Optional.of(new PoolAccess(componentChannel));
    }
